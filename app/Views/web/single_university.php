                ...
                <div class="jsx-43c44c6b135d4931 max-h-[195px] sm:max-h-[420px] h-full rounded-[9px] sm:rounded-[22px] border-2 sm:border-5 border-white overflow-hidden relative shadow-[0px_0px_29.85px_0px_#1D3A5326]">
                    <div class="swiper swiper-initialized swiper-horizontal universityImageSwiper h-full relative" style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff;">
                        <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                            ...
                            <div class="swiper-slide" data-swiper-slide-index="8" style="width: 581px;">
                                <img alt="University of Dundee Others(9)" title="Classroom" fetchpriority="high" width="600" height="400" decoding="async" data-nimg="1" class="h-full w-full" src="" style="color: transparent;"></div>
                            <div class="swiper-slide" data-swiper-slide-index="9" style="width: 581px;">
                                <img alt="University of Dundee Others(10)" title="University of Dundee picture" fetchpriority="high" width="600" height="400" decoding="async" data-nimg="1" class="h-full w-full" src="" style="color: transparent;"></div>
                            <div class="swiper-slide" data-swiper-slide-index="10" style="width: 581px;">
                                <img alt="University of Dundee Others(11)" title="University of Dundee picture" fetchpriority="high" width="600" height="400" decoding="async" data-nimg="1" class="h-full w-full" src="" style="color: transparent;"></div>
                            <div class="swiper-slide" data-swiper-slide-index="11" style="width: 581px;">
                                <img alt="University of Dundee Others(12)" title="University of Dundee picture" fetchpriority="high" width="600" height="400" decoding="async" data-nimg="1" class="h-full w-full" src="" style="color: transparent;"></div>
                        </div>
                    ...
                    <div class="swiper swiper-initialized swiper-horizontal swiper-free-mode swiper-watch-progress universityImageNavigationSwiper absolute bottom-[50px] sm:bottom-[70px] left-2 sm:left-5 w-1/2 !mx-0 swiper-thumbs">
                        <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                            ...
                            <div class="swiper-slide border sm:border-2 border-white rounded-md sm:rounded-lg overflow-hidden" data-swiper-slide-index="5" style="width: 60.5px; margin-right: 16px;">
                                <img alt="University of Dundee Others(6)" title="Library" loading="lazy" width="600" height="400" decoding="async" data-nimg="1" class="h-7 md:h-[50px] w-full" src="" style="color: transparent;"></div>
                            <div class="swiper-slide border sm:border-2 border-white rounded-md sm:rounded-lg overflow-hidden" data-swiper-slide-index="6" style="width: 60.5px; margin-right: 16px;">
                                <img alt="University of Dundee Others(7)" title="Library" loading="lazy" width="600" height="400" decoding="async" data-nimg="1" class="h-7 md:h-[50px] w-full" src="" style="color: transparent;"></div>
                            <div class="swiper-slide border sm:border-2 border-white rounded-md sm:rounded-lg overflow-hidden" data-swiper-slide-index="7" style="width: 60.5px; margin-right: 16px;">
                                <img alt="University of Dundee Others(8)" title="Classroom" loading="lazy" width="600" height="400" decoding="async" data-nimg="1" class="h-7 md:h-[50px] w-full" src="" style="color: transparent;"></div>
                            <div class="swiper-slide border sm:border-2 border-white rounded-md sm:rounded-lg overflow-hidden" data-swiper-slide-index="8" style="width: 60.5px; margin-right: 16px;">
                                <img alt="University of Dundee Others(9)" title="Classroom" loading="lazy" width="600" height="400" decoding="async" data-nimg="1" class="h-7 md:h-[50px] w-full" src="" style="color: transparent;"></div>
                            <div class="swiper-slide border sm:border-2 border-white rounded-md sm:rounded-lg overflow-hidden" data-swiper-slide-index="9" style="width: 60.5px; margin-right: 16px;">
                                <img alt="University of Dundee Others(10)" title="University of Dundee picture" loading="lazy" width="600" height="400" decoding="async" data-nimg="1" class="h-7 md:h-[50px] w-full" src="" style="color: transparent;"></div>
                            <div class="swiper-slide border sm:border-2 border-white rounded-md sm:rounded-lg overflow-hidden" data-swiper-slide-index="10" style="width: 60.5px; margin-right: 16px;">
                                <img alt="University of Dundee Others(11)" title="University of Dundee picture" loading="lazy" width="600" height="400" decoding="async" data-nimg="1" class="h-7 md:h-[50px] w-full" src="" style="color: transparent;"></div>
                            <div class="swiper-slide border sm:border-2 border-white rounded-md sm:rounded-lg overflow-hidden" data-swiper-slide-index="11" style="width: 60.5px; margin-right: 16px;">
                                <img alt="University of Dundee Others(12)" title="University of Dundee picture" loading="lazy" width="600" height="400" decoding="async" data-nimg="1" class="h-7 md:h-[50px] w-full" src="" style="color: transparent;"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class=" overflow-hidden relative w-full lead-form-div border-1.5 border-primary p-[14px] xl:p-[35px] rounded-[25px] bg-white h-fit shadow-[0px_0px_35.6px_0px_#066AC966]">
            <form>
                <div class="shadow-[0px_0px_24px_0px_#0000001A_inset] bg-[#F3F6F9] rounded-[20px] p-2.5 xl:p-10 flex items-center">
                    ...
                    <div class="w-1/3">
                        <img alt="leadFormImage" loading="lazy" width="498" height="394" decoding="async" data-nimg="1" class=" -mb-[75px] ml-[75px]" src="" style="color: transparent;"></div>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class=" m-auto my-12 sm:my-14 xl:px-0 md:-pl-10 blog-slider">
        ...
        <div class="swiper swiper-initialized swiper-horizontal swiper-backface-hidden" lazy="true">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide first:ml-[1.6rem] first:sm:ml-[3rem] first:lg:ml-[4rem] first:xl:ml-[6rem] first:2xl:ml-[18rem] sm:mt-3 sm:mb-16" style="width: 386.857px; margin-right: 40px;" data-swiper-slide-index="4"><a class="overflow-hidden hover:shadow-[0px_4px_14px_0px_#00000040] rounded-2xl block transition-all ease-in-out" href="https://www.gradding.com/blog/university/how-to-get-into-mit-from-india">
                    <img title="How to Get Admission in MIT?" loading="lazy" width="408" height="230" decoding="async" data-nimg="1" class="h-full w-full" src="" style="color: transparent;">
                        <div class="bg-white p-3 lg:p-4 w-full"><span class="font-semibold text-[10px] lg:text-xs xl:text-sm text-[#6E6E73]"> Universities </span>
                ...
                <div class="swiper-slide first:ml-[1.6rem] first:sm:ml-[3rem] first:lg:ml-[4rem] first:xl:ml-[6rem] first:2xl:ml-[18rem] sm:mt-3 sm:mb-16" style="width: 386.857px; margin-right: 40px;" data-swiper-slide-index="5"><a class="overflow-hidden hover:shadow-[0px_4px_14px_0px_#00000040] rounded-2xl block transition-all ease-in-out" href="https://www.gradding.com/blog/university/best-medical-colleges-in-world">
                    <img title="Best Medical Colleges in the World" loading="lazy" width="408" height="230" decoding="async" data-nimg="1" class="h-full w-full" src="" style="color: transparent;">
                        <div class="bg-white p-3 lg:p-4 w-full"><span class="font-semibold text-[10px] lg:text-xs xl:text-sm text-[#6E6E73]"> Universities </span>
                ...
                <div class="swiper-slide first:ml-[1.6rem] first:sm:ml-[3rem] first:lg:ml-[4rem] first:xl:ml-[6rem] first:2xl:ml-[18rem] sm:mt-3 sm:mb-16" style="width: 386.857px; margin-right: 40px;" data-swiper-slide-index="6"><a class="overflow-hidden hover:shadow-[0px_4px_14px_0px_#00000040] rounded-2xl block transition-all ease-in-out" href="https://www.gradding.com/blog/university/cheapest-colleges-in-canada">
                    <img title="Cheapest Colleges in Canada" loading="lazy" width="408" height="230" decoding="async" data-nimg="1" class="h-full w-full" src="" style="color: transparent;">
                        <div class="bg-white p-3 lg:p-4 w-full"><span class="font-semibold text-[10px] lg:text-xs xl:text-sm text-[#6E6E73]"> Universities </span>
