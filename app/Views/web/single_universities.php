                    ...
                    <div class="swiper swiper-initialized swiper-horizontal universityImageSwiper h-full relative" style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff;">
                        <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                            ...
                            <div class="swiper-slide" data-swiper-slide-index="5" style="width: 581px;">
                                <img alt="University of Dundee Others(6)" title="Library" fetchpriority="high" width="600" height="400" decoding="async" data-nimg="1" class="h-full w-full" src="" style="color: transparent;"></div>
                            <div class="swiper-slide" data-swiper-slide-index="6" style="width: 581px;">
                                <img alt="University of Dundee Others(7)" title="Library" fetchpriority="high" width="600" height="400" decoding="async" data-nimg="1" class="h-full w-full" src="" style="color: transparent;"></div>
                            <div class="swiper-slide" data-swiper-slide-index="7" style="width: 581px;">
                                <img alt="University of Dundee Others(8)" title="Classroom" fetchpriority="high" width="600" height="400" decoding="async" data-nimg="1" class="h-full w-full" src="" style="color: transparent;"></div>
